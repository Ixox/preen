...
OBJECTS= build/Env.o build/FM.o build/Osc.o build/Synth.o build/Voice.o build/Lfo.o build/Matrix.o build/RingBuffer.o build/MidiDecoder.o build/Encoders.o build/FMDisplay.o build/SynthStatus.o
...
GLOBAL_CFLAGS   := -O3 -g -mcpu=cortex-m3 -mthumb -march=armv7-m -nostdlib \
                   ...
                   -DBOARD_$(BOARD) -DMCU_$(MCU) -fsigned-char -I/home/xhosxe/libmaple/libraries/LiquidCrystal
...
build/SynthStatus.o: src/SynthStatus.cpp
	$(CXX) -I/home/xhosxe/src $(CFLAGS) $(CXXFLAGS) $(LIBMAPLE_INCLUDES) $(WIRISH_INCLUDES) -o $@ -c $< 
