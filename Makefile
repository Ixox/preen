...
GLOBAL_CFLAGS   := -O3 -g -mcpu=cortex-m3 -mthumb -march=armv7-m -nostdlib \
                   ...
                   -DBOARD_$(BOARD) -DMCU_$(MCU) -fsigned-char -I/home/xhosxe/libmaple/libraries/LiquidCrystal -I/home/xhosxe/libmaple/libraries/Wire
...
build/EncodersListener.o: src/EncodersListener.cpp
	$(CXX) -I/home/xhosxe/src $(CFLAGS) $(CXXFLAGS) $(LIBMAPLE_INCLUDES) $(WIRISH_INCLUDES) -o $@ -c $< 
...
build/SynthParamListener.o: src/SynthParamListener.cpp
	$(CXX) -I/home/xhosxe/src $(CFLAGS) $(CXXFLAGS) $(LIBMAPLE_INCLUDES) $(WIRISH_INCLUDES) -o $@ -c $< 
