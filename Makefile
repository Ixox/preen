...
PREENFM_VERSION_NUMBER=1.03
PREENFM_VERSION=\"$(PREENFM_VERSION_NUMBER)\"

LIB_MAPLE_HOME=/home/xhosxe/libmaple

OBJECTS= build/Env.o build/FM.o build/Osc.o build/Synth.o build/Voice.o build/Lfo.o build/Matrix.o build/RingBuffer.o build/MidiDecoder.o build/Encoders.o build/FMDisplay.o build/SynthState.o build/Menu.o build/PresetUtil.o build/Presets.o build/LfoOsc.o build/LfoEnv.o
